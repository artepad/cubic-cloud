...
<body class="mini-sidebar">
    ...
    <section id="wrapper" class="login-register">
        <div class="login-box">
            <div class="white-box">
                ...
                <form class="form-horizontal form-material" id="resetform" action="<?= base_url ?>usuario/doReset" method="POST">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary p-t-0">
                                <p>Tu contraseña debe tener al menos 8 caracteres, incluir una letra mayúscula, una minúscula y un número.</p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.getElementById('resetform').addEventListener('submit', function(e) {
            ...
            // Validación adicional para incluir mayúsculas, minúsculas y números
